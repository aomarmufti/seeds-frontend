...
export const OFFER = {
  ...
  trialFull: 'free 30-minute trial lesson',
  trialDuration: '30 minutes',
  // The two together, as a sequence.
  sequence: 'Free consultation (15-min call) → free trial lesson (30 min)',
};
...
export const PRICES = [
  {
    ...
    price: '£40',
    unit: 'per 1:1 lesson',
    blurb: 'KS3 and GCSE one-to-one, 55 minutes with a subject specialist.',
    features: [
      '55-minute live 1:1 lesson on Google Meet',
  ...
  },
  {
    ...
    unit: 'per 1:1 lesson',
    featured: true,
    blurb: 'A-Level one-to-one, 55 minutes with a specialist in your exam board.',
    features: [
      'Everything in GCSE',
